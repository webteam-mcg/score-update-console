<template>
  <div id="scorePanel">
    ...
    <table style="width: 100%;">
      ...
      <tr>
        ...
        <td>
          <select v-model="type">
            ...
            //c "Player Name" b "Bowler Name"
            <option value="run">Run Out</option>
            // run out("Player Name")
            <option value="st">Stumping</option>
            //st "Player Name" b "Player Name"
      ...
      <tr>
        <td colspan="4">
          <button class="button" @click="addWicket()">Update</button>
        </td>
      </tr>
    </table>
  </div>
